...
type ComentarioIconProps = {
  size?: number;
  color?: string;
};

export function ComentarioIcon({
  size = 24,
  color = '#000',
}: ComentarioIconProps) {
  return (
