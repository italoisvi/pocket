      ...
      parameters: {
        ...
        properties: {
          ...
          category: {
            type: 'string',
            description:
              'Categoria do gasto. Se não especificado, será inferida automaticamente. IMPORTANTE: Para alimentação fora de casa (restaurante, delivery, padaria, lanchonete, açaí, café, bar) use alimentacao_fora. Para supermercado/feira use alimentacao_casa.',
            enum: [
              'moradia',
              'alimentacao_casa',
              'alimentacao_fora',
          ...
          image_url: {
            type: 'string',
            description:
              'URL da imagem do comprovante. IMPORTANTE: Se o usuário enviou uma imagem na conversa e pediu para registrar o gasto, você DEVE passar a URL da imagem aqui para que o comprovante fique salvo junto com o gasto.',
          },
        },
