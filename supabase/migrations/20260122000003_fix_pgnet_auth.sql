-- Corrige autenticação do pg_net: adiciona header 'apikey' necessário para Edge Functions
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- IMPORTANTE: Adicionar 'apikey' header necessário para Supabase Edge Functions
...
-- Atualizar também a função de teste
...
BEGIN
  ...
  -- Fazer uma requisição de teste COM apikey header
  SELECT net.http_post(
